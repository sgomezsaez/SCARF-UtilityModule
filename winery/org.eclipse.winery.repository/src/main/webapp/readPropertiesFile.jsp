...
String policyTemplateNamespace;
String fileName = "/WEB-INF/classes/winery.properties";
String fullName = application.getRealPath(fileName);
FileInputStream f = new FileInputStream(fullName);
...
if (f != null){
  ...
  out.print(",End Here,");
  out.print(policyTemplateNamespace);
  out.print(",End Here,");
}
