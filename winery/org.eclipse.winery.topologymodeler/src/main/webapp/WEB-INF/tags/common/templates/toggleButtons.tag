...
<div class="btn-group" data-toggle="buttons-checkbox" id="toggleButtons">
	...
	<div class="btn-group">
	<button type="button" class="btn btn-dropdown" data-toggle="dropdown" aria-expanded="false">Policies<span class="caret"></span></button>
		<ul class="dropdown-menu" role="menu">
			<li><button class="btn btn-default" id="PoliciesVisibility1" onclick="showOrHidePolicies(!$(this).hasClass('active'));">Performance</button></li>
			<li><button class="btn btn-default" id="PoliciesVisibility3" onclick="showOrHidePolicies(!$(this).hasClass('active'));">Other</button></li>
		</ul>		
	</div>
	<button class="btn btn-default" id="workloadLink" onclick="workloadLink();">Workload</button>
</div>
