...
<head>
	...
	<link rel="stylesheet" href="css/metricstable.css" />
</head>
...
<pol:policydiag allPolicyTypes="<%=allTypes%>" repositoryURL="<%=repositoryURL%>" serviceTemplateName="<%=serviceTemplateName%>"/>
<script>
"use strict";
...
<script>
	...
	$(document).on("mousedown", "div.NodeTemplateShape", function(e) {
		...
		if (target.hasClass("policy")) {
			...
			if(showUpdateDiagForPolicy(policy)){
			return false;
			}
		}
