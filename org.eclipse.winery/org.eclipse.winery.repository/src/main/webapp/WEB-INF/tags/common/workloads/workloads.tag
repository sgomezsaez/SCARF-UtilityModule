...
<div class="policiesContainer">
	...
	<div class="content">
		...
		<div class="addnewpolicy row" style="display:none;">
			<button class="btn btn-default center-block btn" onclick="showAddDiagForPolicy($(this).parent().parent().parent().parent());">Add new policy</button>
			<button class="btn btn-default center-block btn" onclick="showDiagPolicyType();">Policy Type</button>
			<button class="btn btn-default center-block btn" onclick="showDiagPolicyTemplate();">Policy Template</button>
		</div>
	</div>
</div>
